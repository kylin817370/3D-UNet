...
parser.add_argument('--dataset_path', default='/mnt/sdc1/EZY/LITS——FIXED', help='fixed trainset root path')
parser.add_argument('--test_data_path', default='/mnt/sdc1/EZY/LiTS/test', help='Testset path')
